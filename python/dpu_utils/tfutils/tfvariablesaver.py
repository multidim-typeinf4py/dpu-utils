...
class TFVariableSaver:
    ...
    def save_all(self, session: tf.compat.v1.Session, exclude_variable: Optional[Callable[[str], bool]]=None) -> None:
    ...
    def restore_saved_values(self, session: tf.compat.v1.Session) -> None:
